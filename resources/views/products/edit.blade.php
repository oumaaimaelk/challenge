...
<div class="container">
		<div class="col-sm-10" style="width: 600px; margin-left: 250px; margin-top: 50px;">
			<div class="jumbotron">
				<div class="form-group" style="margin-top: -50px;">
					...
					<form   action="{{url('/edit-product/'.$product->id)}}"  method="POST"  autocomplete= "off" class="form-horizontal" style="margin-left: 50px;">
						{{csrf_field()}}
	...
	<label> Name: </label>
					...
					<label> Description: </label>
						...
						<select  class="form-control action" name="category_id" 
						  required>
